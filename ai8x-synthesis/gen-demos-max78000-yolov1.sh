...
./ai8xize.py --verbose --log --overwrite --fifo --test-dir $TARGET --prefix yolov1 --checkpoint-file $CHECKPOINT --config-file networks/yolo-224-hwc-ai85.yaml $COMMON_ARGS "$@"
